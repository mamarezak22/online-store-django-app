...
from .views import CheckCodeView, CustomTokenObtainPairView , GetCodeView, PasswordForgotCheckCodeView, PasswordForgotGetCodeView, RegisterUserView,UserDetailView 
